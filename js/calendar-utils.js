console.info('Smart Task Flow calendar-utils.js v20260626-module-split-phase4b-day-renderer loaded');
...
function getMonthlySubTasks(task, monthStart, monthEnd, todayStr) { const allSubTasks = Array.isArray(task.subTasks) ? task.subTasks : []; return { allSubTasks, visibleSubTasks: allSubTasks.filter(st => dateRangeOverlaps(st, monthStart, monthEnd, todayStr)) }; }
