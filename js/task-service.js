console.info('Smart Task Flow task-service.js v20260626-module-split-phase3-task-service loaded');
// Task / tracker CRUD and Firebase realtime listener helpers.
// Loaded after app.js so it can call UI functions declared in app.js.
