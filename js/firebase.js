...
import { getFirestore, enableIndexedDbPersistence, collection, doc, setDoc, writeBatch, onSnapshot, serverTimestamp, getDoc, getDocs, query, where, orderBy, deleteDoc, updateDoc, arrayUnion } from "https://www.gstatic.com/firebasejs/10.8.1/firebase-firestore.js";
...
window.db = db;
window.auth = auth;
window.fs = { collection, doc, setDoc, writeBatch, onSnapshot, serverTimestamp, getDoc, getDocs, query, where, orderBy, deleteDoc, updateDoc, arrayUnion };
